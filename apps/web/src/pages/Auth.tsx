...
export function AuthPage({ mode }: { mode: AuthMode }) {
  ...
  async function signInWithGoogle() {
    ...
    try {
      ...
      // On success Better Auth redirects to Google; keep pending until navigation.
    } catch {
      setError(t`Could not reach the server`);
      setPending(false);
    }
...
function GoogleGlyph() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="mr-2 size-5" width="20" height="20">
      <path
        fill="#4285F4"
